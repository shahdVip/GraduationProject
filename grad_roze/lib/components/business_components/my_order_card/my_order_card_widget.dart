...
import '/components/business_components/my_order_view/my_order_view_widget.dart';
import 'dart:math';
import 'dart:ui';
...
import 'my_order_card_model.dart';
export 'my_order_card_model.dart';

class MyOrderCardWidget extends StatefulWidget {
  final dynamic order;
  const MyOrderCardWidget({super.key, required this.order});
...
class _MyOrderCardWidgetState extends State<MyOrderCardWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyOrderCardModel());
                            ...
                            builder: (context) {
                              return WebViewAware(
                                child: Padding(
                                  ...
                                  child: MyOrderViewWidget(order: widget.order),
                                ),
                              );
                            },
