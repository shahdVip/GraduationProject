...
export 'my_order_view_model.dart';

class MyOrderViewWidget extends StatefulWidget {
  final dynamic order; // Pass the order object

  const MyOrderViewWidget({super.key, required this.order});

  @override
  State<MyOrderViewWidget> createState() => _MyOrderViewWidgetState();
}

class _MyOrderViewWidgetState extends State<MyOrderViewWidget>
    with TickerProviderStateMixin {
  late MyOrderViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyOrderViewModel());
